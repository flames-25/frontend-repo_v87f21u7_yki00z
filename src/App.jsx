        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="flex">
            ...
            <main className="flex-1 min-w-0">
              ...
              {/* Sections */}
              <div id="playlists"><PlaylistGrid /></div>
              <div id="tracks"><TrackList /></div>

              {/* Simple recommendation/for you section */}
              <section className="px-6 md:px-10 py-8">
                <h2 className="mb-4 text-lg md:text-xl font-semibold text-zinc-100">For You</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="rounded-2xl border border-white/5 bg-zinc-900/40 p-6">
                    <div className="mb-4 h-56 overflow-hidden rounded-xl ring-1 ring-white/10">
                      <img src="https://images.unsplash.com/photo-1518397387277-7843f7251311?q=80&w=1600&auto=format&fit=crop" alt="Recommendation" className="h-full w-full object-cover" />
                    </div>
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-zinc-100">Hyperlane Mix</p>
                        <p className="text-xs text-zinc-400">Curated for your night drive</p>
                      </div>
                  ...
                  <div className="rounded-2xl border border-white/5 bg-zinc-900/40 p-6">
                    <h3 className="text-sm text-zinc-300">Fresh Picks</h3>
